...
export default function Skills() {
  ...
  return (
    <div>
        ...
        <Grid xs={12} container className="new">
      ...
      <Grid xs={12} container className="new" sx={{ mt:2}}>
            <Grid sm={12} md={6} lg={4} className="name">
      ...
      <Grid xs={12} container className="new" sx={{}}>
            <Grid sm={12} md={6} lg={6} className="name" sx={{mt:2}}>
        ...
        <Grid sm={12} md={6} lg={6} className="name" sx={{mt:4}}>
                <h4 className="languages">Databases</h4>
                <span className="textBox">MongoDB</span>
                <span className="textBox">FaunaDB</span>
        </Grid>
      </Grid>
      <Grid xs={12} container className="new" sx={{mt:4}}>
            <Grid sm={12} md={12} lg={12} className="name">
